...
from clypto.collection.bio_based import (BBO, BBOA, BMO, EOA, SBO, SMA, SOA, SOS, TPO, TSA, VCS, WHO, BCO, EAO, SFOA)
...
from clypto.collection.math_based import (AOA, CEM, CGO, GBO, HC, INFO, PSS, RUN, SCA, SHIO, TS)
from clypto.collection.math_based import CircleSA
from clypto.collection.music_based import HS
from clypto.collection.physics_based import (ArchOA, EFO, EO, EVO, FLA, HGSO, MVO, NRO, SA, TWO, WDO, ESO, SOO, MSO)
...
from clypto.collection.swarm_based import (ABC, ACOR, AVOA, BES, BFO, COA, DMOA, DO, FA, GJO, GWO, HBA, MPA, MSA, MShOA,
                                           ...
                                           FDO)
from clypto.collection.swarm_based import AO, JA, EHO, NMRA, PSO, CoatiOA, BA, TSO, GOA, MFO, SLO, ARO, SquirrelSA, FFA, \
    POA, \

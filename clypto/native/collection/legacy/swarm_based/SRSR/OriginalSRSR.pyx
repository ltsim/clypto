...
cdef class _OriginalSRSRAgent(_LegacyAgent):
    cdef public object mu
    cdef public object sigma
    cdef public object solution_new
    cdef public object target_move
    cdef public object target_new
    def __init__(self, solution=None, target=None, mu=None, sigma=None, solution_new=None, target_move=None, target_new=None):
    ...
    def update(self, **kwargs):
        ...
        if "solution_new" in kwargs:
            self.solution_new = kwargs.pop("solution_new")
        if "target_move" in kwargs:
            self.target_move = kwargs.pop("target_move")
        if "target_new" in kwargs:
            self.target_new = kwargs.pop("target_new")
        _LegacyAgent.update(self, **kwargs)


cdef class OriginalSRSR(_LegacyOptimizer):
    """

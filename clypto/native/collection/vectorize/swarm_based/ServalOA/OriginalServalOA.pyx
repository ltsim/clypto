...
cdef class OriginalServalOA(VectorizeOptimizer):
    """
    ...
    Examples
    ~~~~~~~~
    >>> from clypto.native.collection.vectorize.swarm_based import ServalOA    >>> import numpy as np
    ...
    def _evolve(self, int epoch_c):
        ...
        ops.step(self, X + rng.integers(1, 3, size=(n, d)) * (self.problem.bounds.up - self.problem.bounds.low) / epoch)

...
cdef class OriginalCSO(AgentListOptimizer):
    """
    ...
    cdef public object smp
    cdef public object spc
    cdef public object cdc
    cdef public object srd
    cdef public object c1
    cdef public object w_min
    cdef public object w_max
    cdef public object selected_strategy
    ...
    def evolve_agents(self, epoch):
        ...
        for idx in range(0, self.pop_size):
            ...
            # tracing mode
            if self.objs[idx].flag:
                pos_new = (
                    self.objs[idx].solution
                    + w * self.objs[idx].velocity

...
cdef class OriginalDO(VectorizeOptimizer):
    """
    ...
    Examples
    ~~~~~~~~
    >>> from clypto.native.collection.vectorize.swarm_based import DO    >>> import numpy as np
    ...
    def _evolve(self, int epoch_c):
        ...
        gw = X[int(F.argmax() if self.problem.sense == "min" else F.argmin())]

...
class OriginalGWO(OptimizerV1):
    ...
    Examples
    ~~~~~~~~
    >>> from mealprint.collection.swarm_based import GWO    >>> import numpy as np
...
class IncrementalGWO(OptimizerV1):
    """

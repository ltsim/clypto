...
class OriginalGTO(OptimizerV1):
    ...
    Examples
    ~~~~~~~~
    >>> from mealprint.collection.swarm_based import GTO    >>> import numpy as np
...
class Matlab102GTO(OptimizerV1):
    """
...
class Matlab101GTO(OptimizerV1):
    """

...
class OriginalPSO(OptimizerClassic):
    """
    ...
    Examples
    ~~~~~~~~
    >>> from mealprint.collection.swarm_based import PSO    >>> import numpy as np
...
class AIW_PSO(OptimizerClassic):
    """
...
class LDW_PSO(OptimizerClassic):
    """

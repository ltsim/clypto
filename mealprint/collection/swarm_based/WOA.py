...
class OriginalWOA(OptimizerClassic):
    """
    ...
    Examples
    ~~~~~~~~
    >>> from mealprint.collection.swarm_based import WOA    >>> import numpy as np

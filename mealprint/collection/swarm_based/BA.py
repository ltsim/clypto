...
class OriginalBA(OptimizerClassic):
    """
    ...
    Examples
    ~~~~~~~~
    >>> from mealprint.collection.swarm_based import BA    >>> import numpy as np
...
class AdaptiveBA(OptimizerClassic):
    """

...
class OriginalDE(OptimizerClassic):
    """
    ...
    Examples
    ~~~~~~~~
    >>> from mealprint.collection.evolutionary_based import DE    >>> import numpy as np

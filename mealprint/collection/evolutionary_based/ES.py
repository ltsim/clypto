...
class OriginalES(OptimizerClassic):
    """
    ...
    Examples
    ~~~~~~~~
    >>> from mealprint.collection.evolutionary_based import ES    >>> import numpy as np
...
class Simple_CMA_ES(OptimizerClassic):
    """

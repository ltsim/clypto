...
class ParameterGrid:
    ...
    Examples
    --------
    >>> from mealprint.tuner import ParameterGrid
...
class Tuner:
    ...
    def __init__(self, algorithm: Union[str, OptimizerV1] = None, param_grid: Union[Dict, List] = None,
                 **kwargs: object) -> None:
        self.__set_keyword_arguments(kwargs)
        self.validator = Validator(log_to="console", log_file=None)
        self.algorithm = self.validator.check_is_instance("algorithm", algorithm, OptimizerV1)
